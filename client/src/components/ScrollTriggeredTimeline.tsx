...
const timelineEvents: TimelineEvent[] = [
    ...
    {
        time: "4:45 - 5:15 PM",
        event: "Photo Ops & Cocktail",
        description: "Capture beautiful moments and enjoy refreshments as we celebrate together.",
        icon: Camera,
        hueA: 40,
        hueB: 40,
    },
    {
        time: "5:15 - 5:45 PM",
        event: "Simple and Intimate Program",
        description: "A heartfelt celebration of our journey together with special moments.",
        icon: Music,
        hueA: 40,
        hueB: 40,
    },
    {
        time: "5:45 - 7:00 PM",
        event: "Dinner",
        description: "Enjoy delicious cuisine prepared specially for our celebration.",
        icon: Utensils,
        hueA: 40,
        hueB: 40,
    },
    {
        time: "7:00 - 8:00 PM",
        event: "Party",
        description: "Join us in a joyful celebration of love, laughter, and gratitude on the dance floor.",
        icon: PartyPopper,
        hueA: 40,
        hueB: 40,
    },
...
export default function ScrollTriggeredTimeline() {
    return (
        <motion.section 
            id="timeline" 
            className="section-pastel-blue bg-white relative overflow-hidden mt-[25px] mb-[25px]"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
